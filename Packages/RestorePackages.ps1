...
Function Shell-UnZip($Source, $Folder)
{
...
Function Shell-UnzipNet45([String]$sourceFile,[String]$targetFolder)
{
...
param(
[Parameter(Position=0,Mandator=$True,HelpMessage="Unzip sources")]
...
IF($PSVersionTable.CLRVersion.Major -ge 4){
    Shell-UnzipNet45 $Source $Folder
}ELSE{
    Shell-UnZip $Source $Folder
}
}
