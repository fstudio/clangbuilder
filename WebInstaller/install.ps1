<#
# https://raw.githubusercontent.com/forcegroup/ClangSetupvNext/master/WebInstaller/install.ps1 Internet Installer.
# Run PowerShell IEX 
#>
...
$OfficaUrl="https://github.com/forcegroup/ClangSetupvNext/archive/master.zip"
